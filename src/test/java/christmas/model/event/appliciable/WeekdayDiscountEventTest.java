...
public class WeekdayDiscountEventTest {
    ...
    void given_ordersAtWeekend_when_apply_then_notAppliedDiscount() {
        ...
        Map<EventKind, Integer> result = EventUtil.applyAndGetBenefitResult(weekDayDiscountEvent, eventPlanner);
        boolean isEventApplied = result.containsKey(weekDayDiscountEvent.getKind());
